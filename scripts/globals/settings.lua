...
REGIME_WAIT = 0 -- Make people wait till 00:00 game time as in retail. If it's 0, there is no wait time.FOV_REWARD_ALLIANCE = 0 -- Allow Fields of Valor rewards while being a member of an alliance. (default retail behavior: 0)
...
-- DYNAMIS SETTINGS
    ...
    TIMELESS_HOURGLASS_COST = 500   -- refund for the timeless hourglass for Dynamis.
...
TIMEZONE_OFFSET = 8.0 -- Offset from UTC used to determine when "JP Midnight" is for the server.  Default is JST (+9.0).
